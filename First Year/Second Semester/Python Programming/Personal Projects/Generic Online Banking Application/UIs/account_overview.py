...
class AccountOverviewMenu(tk.Tk):
    ...
    def __init__(self,OnlineBankingAccount):
        ...
        def show_accounts():
            # read the valid accounts from the database
            pass
        def getAccountsTotalBalance():
            # using the Accounts class method to retrieve the calculation from reading the database
            pass
        ...
        for account in cust_accts.values():
            ...
            row += 1
            total = total + float(account.balance)
